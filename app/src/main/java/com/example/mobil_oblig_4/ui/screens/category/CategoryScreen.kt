...
private fun categoryImageRes(category: BikeCategory): Int {
    return when (category) {
        BikeCategory.Road -> com.example.mobil_oblig_4.R.drawable.road_bike_24
        BikeCategory.Mountain -> com.example.mobil_oblig_4.R.drawable.mountain_bike_24
        BikeCategory.Hybrid -> com.example.mobil_oblig_4.R.drawable.hybrid_bike_24
        BikeCategory.Gravel -> com.example.mobil_oblig_4.R.drawable.gravel_bike_24
        BikeCategory.KidsBike -> com.example.mobil_oblig_4.R.drawable.kids_bike_24
    }
}
